"""
SafeClaw Webhook System - Inbound and outbound webhooks.
...
class WebhookServer:
    ...
    def __init__(
        ...
        self.app = FastAPI(
            title="SafeClaw Webhooks",
            description="Webhook receiver for SafeClaw automation",
            version="0.1.0",
        )
        self._setup_routes()
    ...
    def _setup_routes(self) -> None:
        ...
        @self.app.get("/health")
        async def health():
            return {"status": "ok", "service": "safeclaw-webhooks"}
...
class WebhookClient:
    ...
    async def send(
        ...
        if secret:
            ...
            headers["X-SafeClaw-Signature"] = f"sha256={signature}"
